...
static sp_t wifi_hardware_init()
{
    ...
    ret=esp_event_handler_instance_register(IP_EVENT,ESP_EVENT_ANY_ID,&wifi_event_handle,NULL,NULL);
    //启动WiFi
    ret=esp_wifi_start();
    //WiFi读取
    wifi_read();
